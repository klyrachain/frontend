...
- #BusinessPage  NO Product page
- #BusinessPage Duplicate Business name on topnav 
- #BusinessPage  Active search input bg color is white (should be PRIMARY_HEX_COLOR) 
- #BusinessPage: Settings information using default hardcoded values.
- Gas sponsorship page
- Team shows signin to your business acc. 
- #BusinessPage Payment link Status should contain, active, paid, inactive/expired, pending. #NewFeature 
- #BusinessPage  Payment Link webhook for awaiting transactions. #NewFeature
- #BusinessPage  Payment link table footer needs spacing. 
- #BusinessPage  Dashboard / Home page should list top 10 transactions & Payouts (just like on admin page)
- #BusinessPage  Dashboard / Home Page ==reporting== should  KYB status (KYB: NOT_STARTED) is a turnoff
- #BusinessPage Products route to Inventory
- #BusinessPage Payment Links messaging & spacing is a mess
- #BusinessPage Invoice should auth error even tho I am logged in. 
- #BusinessPage API page Key rotation scheduled, is it a feature? 
- #BusinessPage Topnav Component Toggle between live and test should require confirmation. 
